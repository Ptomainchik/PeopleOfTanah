...
export const HistoryConfederation = () => {
    ...
    return (
        <div className={classes.historyPageConfederation}>
            ...
            <button className={classes.buttonOpenModal1} id={"1"} onClick={() => {handleOpenModal("1")}}><p className={classes.titleChapterHistory} style={{color: "goldenrod"}}>Глава 1</p></button>
            ...
            <button className={classes.buttonOpenModal2} id={"2"} onClick={() => {handleOpenModal("2")}}><p className={classes.titleChapterHistory} style={{color: "goldenrod"}}>Глава 2</p></button>
            ...
            <button className={classes.buttonOpenModal3} id={"3"} onClick={() => {handleOpenModal("3")}}><p className={classes.titleChapterHistory} style={{color: "goldenrod"}}>Глава 3</p></button>
            {showModalId === "3" && (<div className={buttonClassLeft} id={"3"} style={{border: "solid 0.3vw goldenrod"}}>
                <h4 style={{color:"goldenrod"}}>Глава 3</h4>
                <p style={{color:"goldenrod"}}>
                    Зарождение религии, а если говорить точнее - мировоззрения Конфедерации племён, ведёт своё начало из древности, когда континент был охвачен Эпохой Зимы.
                    ...
                    Однако некоторые остались, продолжая бороться с суровыми холодами. За тысячелетнюю Эпоху Зимы оставшиеся регистаны смешались с малочисленным эльфийским народом, иногда появлявшимся в тех землях: от их союзов появились предки инмарцев с белой кожей и менее выдающимся ростом.
                    Сквозь тысячелетия выжившие потомки таких союзов забыли свои истинные корни. Былое наследие в виде руин и каменных изваяний животных превратилось для них в объекты поклонения, став своеобразными богами.
                    ...
                    Попытки вернуть заблудших сородичей к истокам не увенчались успехом, приводя лишь к распрям и локальным конфликтам. 
            ...
            <button className={classes.buttonOpenModal4} id={"4"} onClick={() => {handleOpenModal("4")}}><p className={classes.titleChapterHistory} style={{color: "goldenrod"}}>Глава 4</p></button>
            {showModalId === "4" && (<div className={buttonClassRight} id={"4"} style={{border: "solid 0.3vw goldenrod"}}>
                ...
                <p style={{color:"goldenrod"}}>
                    ...
                    Хотя и с осторожностью, многие караваны выходят за пределы Великой пустыни, продвигая товары государства за рубежом и закупая иностранные. 
            ...
            <button className={classes.buttonOpenModal5} id={"5"} onClick={() => {handleOpenModal("5")}}><p className={classes.titleChapterHistory} style={{color: "goldenrod"}}>Глава 5</p></button>
