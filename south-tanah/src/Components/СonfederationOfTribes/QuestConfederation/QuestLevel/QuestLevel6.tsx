...
export const Level6 = (props:any) => {
    ...
    return (
        <div className={classes.questPage} style={{backgroundImage: `url(${DesertTexture})`}}>
            ...
            <div className={classes.playingFieldLevel6} style={{backgroundImage: `url(${StreetsOfKillat})`, border: " solid 0.3vw goldenrod"}}>
                <img src={OldWoman} alt="OldWoman"  className={classes.characterConfederationImg6}/>
            </div>
