...
import DesertInmar from "../../../../Images/DesertInmar.jpg";
...
export const Level3 = (props:any) => {
    ...
    return (
        <div className={classes.questPage} style={{backgroundImage: `url(${DesertTexture})`}}>
            ...
            <div className={classes.playingFieldLevel3} style={{backgroundImage: `url(${DesertInmar})`, border: " solid 0.3vw goldenrod"}}>
                <img src={GuardInmar} alt="GuardInmar"  className={classes.characterConfederationImg3}/>
            </div>
