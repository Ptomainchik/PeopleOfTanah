...
export const Level5 = (props:any) => {
    ...
    return (
        <div className={classes.questPage} style={{backgroundImage: `url(${DesertTexture})`}}>
            ...
            <div className={classes.playingFieldLevel5} style={{backgroundImage: `url(${ForestInmar})`, border: " solid 0.3vw goldenrod"}}>
                <img src={Bandit} alt="Bandit"  className={classes.characterConfederationImg5}/>
            </div>
