...
export const Level7 = (props:any) => {
    ...
    return (
        <div className={classes.questPage} style={{backgroundImage: `url(${DesertTexture})`}}>
            ...
            <div className={classes.playingFieldLevel7} style={{backgroundImage: `url(${BullTemple})`, border: " solid 0.3vw goldenrod"}}>
                <img src={Acolyte} alt="Acolyte"  className={classes.characterConfederationImg7}/>
            </div>
