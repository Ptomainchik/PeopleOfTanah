...
export const Level2 = (props:any) => {
    ...
    return (
        <div className={classes.questPage} style={{backgroundImage: `url(${DesertTexture})`}}>
            ...
            <div className={classes.playingFieldLevel2} style={{backgroundImage: `url(${CamelCaravaner})`, border: " solid 0.3vw goldenrod"}}>
                <img src={RegistanWoman} alt="RegistanWoman"  className={classes.characterConfederationImg2}/>
            </div>
