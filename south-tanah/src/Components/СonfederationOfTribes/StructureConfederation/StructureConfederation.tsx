            ...
            <div>
                ...
                {showModalId === "3" && (<div className={structureConfederation} style={{border: "solid 0.3vw rgb(20, 107, 122)"}}>
                    ...
                    <p style={{color: " rgb(20, 107, 122)"}}>
                        ...
                        Их творческий гений не знает границ - будь то поэзия, живопись, архитектура или скульптура. Именно они создавали те загадочные руины в Инмаре с изысканными барельефами ещё до Эпохи Зимы, которым теперь поклоняются их заблудшие северные соседи.
