                ...
                <div>
                    ...
                    {showModalId === "2" && (<div className={classes.modalStructure} id={"2"} style={{border: "solid 0.3vw blueviolet"}}>
                            ...
                            <p style={{color: "blueviolet"}}>
                                ...
                                Обнимаемый западными ветрами, здесь расположился трудолюбивый и умиротворённый город Кива. В этом краю искусство трудиться и жить во благо королевства возведено в культ.
                            </p>
                        <div>
