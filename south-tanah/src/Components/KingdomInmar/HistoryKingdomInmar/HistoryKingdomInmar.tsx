        ...
        <div className={classes.historyPageInmar}>
            ...
            {showModalId === "2" && (<div className={buttonClassRight} id={"2"} style={{border: "solid 0.3vw darkred"}}>
                ...
                <p style={{color: "darkred"}}>
                    ...
                    Но идиллия была разрушена. Разгневанный человеческим неблагодарностью и недостаточным почитанием, Белый Бык наслал на мир катаклизм Эпохи Зимы. Лишь пройдя через ледяное чистилище, уцелевшие люди осознали свою ошибку.
