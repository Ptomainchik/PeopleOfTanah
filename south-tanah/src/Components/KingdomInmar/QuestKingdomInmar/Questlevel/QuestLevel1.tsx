...
export const Level1 = (props:any) => {
    ...
    return (
        <div className={classes.questPage} style={{ backgroundImage: `url(${StoneTexture})` }}>
            ...
            <div className={classes.playingFieldLevel} style={{backgroundImage: `url(${RoomCastle})`, border: "solid 0.3vw goldenrod"}}>
                <img src={MorningSquire} alt="MorningSquire"  className={classes.characterInmarImg1}/>
            </div>
