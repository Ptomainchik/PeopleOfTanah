        ...
        <div className={classes.questPage} style={{ backgroundImage: `url(${StoneTexture})` }}>
            {showOpeningScene && <div className={classes.openingScene}>
                <p>
                    ...
                    В своей жизни он видел магистра лишь несколько раз: и тогда, когда вступал в орден, и тот проводил инициацию, принимая клятву верности у двадцатидвухлетнего юноши.
                    С тех пор прошло долгих сорок лет, за которые он так ничего и не добился на поприще служения ордену, лишь изредка получая задания по доставке королевских депеш.
