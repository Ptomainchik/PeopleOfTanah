...
export const Level3 = (props:any) => {
    ...
    return (
        <div className={classes.questPage} style={{ backgroundImage: `url(${StoneTexture})` }}>
            ...
            <div className={classes.playingFieldLevelInmar3} style={{border: "solid 0.3vw darkred"}}>
            ...
            {showMessageQuest.message6 && <div className={classes.openingScene}>
                <p>
                    ...
                    Ведь он до сих пор не умел плавать - и только сейчас вспомнил об этом, нервно напевая детскую песенку про рыбака и постукивая пальцами по эфесу своего меча.
