    ...
    return (
        <div className={classes.questPage}>
            <div className={classes.playingFieldLevel5}>
                <img src={CaravanerMerchant} alt="CaravanerMerchant"  className={classes.characterImg5}/>
                <img src={RegistanGuard} alt="RegistanGuard"  className={classes.characterImg51}/>
            </div>
