        ...
        <div className={classes.questPage} style={{ backgroundImage: `url(${StoneTexture})` }}>
            ...
            {showOpeningScene2 && <div className={classes.openingScene}>
                <p>
                    ...
                    Пожав ему руку, парень понимающе кивнул и улыбнулся в ответ, лишь сказав ему: - Я знаю, Корос, я знаю. Затем рыцарь молча развернулся и пошёл в сторону прибрежных улиц.
