...
import OldCertificate from "../../../../Images/OldCertificate.webp";
...
export const Level7 = (props:any) => {
    ...
    return (
        <div className={classes.questPage} style={{ backgroundImage: `url(${StoneTexture})` }}>
            ...
            <div className={classes.playingFieldLevel} style={{backgroundImage: `url(${PrisonRoom})`, border: "solid 0.3vw darkred"}}>
            ...
            {showMessageQuest.message8 && <div className={classes.blockMessage} style={{border: "solid 0.3vw darkred"}}>
                ...
                <p className={classes.question}>
                    ...
                    Двести лет мы пытались вымолить у них хоть крупицу милосердия - но все наши попытки солдаты Инмара пресекали с беспощадной жестокостью.
                </p>
                <div>
                    <p className={classes.buttonNextMessageInmar} onClick={handleNextMessage}> ---Продолжить--- </p>
                </div>
            ...
            {showMessageQuest.message12 && <div className={classes.blockMessage} style={{border: "solid 0.3vw darkred"}}>
                <h1>Губернатор:</h1>
                <p className={classes.question}>
            ...
            {showMessageQuest.message13 && <div className={classes.blockMessage} style={{border: "solid 0.3vw darkred"}}>
                <h1>Губернатор:</h1>
                <p className={classes.question}>
            ...
            {showMessageQuest.message14 && <div className={classes.blockMessage} style={{border: "solid 0.3vw darkred"}}>
                <h1>Губернатор:</h1>
                <p className={classes.question}>
            ...
            {showMessageQuest.message15 && <div className={classes.openingScene} style={{border: "solid 0.3vw darkred"}}>
                <img src={OldCertificate} alt="OldCertificate"/>
            ...
            {showMessageQuest.message16 && <div className={classes.blockMessage} style={{border: "solid 0.3vw darkred"}}>
                <h1>----------</h1>
                <p className={classes.question}>
            ...
            {showMessageQuest.message17 && <div className={classes.blockMessage} style={{border: "solid 0.3vw darkred"}}>
                <h1>Губернатор:</h1>
                <p className={classes.question}>
            ...
            {showMessageQuest.message18 && <div className={classes.blockMessage} style={{border: "solid 0.3vw darkred"}}>
                <h1>Губернатор:</h1>
                <p className={classes.question}>
            ...
            {showMessageQuest.message21 && <div className={classes.blockMessage} style={{border: "solid 0.3vw darkred"}}>
                <h1>Губернатор:</h1>
                <p className={classes.question}>
            ...
            {showMessageQuest.message22 && <div className={classes.openingScene} style={{border: "solid 0.3vw darkred"}}>
                <p>
