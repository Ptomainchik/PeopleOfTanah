...
export const Level2 = (props:any) => {
    ...
    return (
        <div className={classes.questPage} style={{ backgroundImage: `url(${StoneTexture})` }}>
            ...
            <div className={classes.playingFieldLevel} style={{backgroundImage: `url(${CabinetCastle})`, border: "solid 0.3vw goldenrod"}}>
                {!showMessageQuest.message1 && !showMessageQuest.message6 && !showMessageQuest.message7 && <img src={Master} alt="Master"  className={classes.characterInmarImg2}/>}
            </div>
            ...
            {showMessageQuest.message8 && <div className={classes.openingScene} style={{ border:"solid 0.3vw goldenrod"}}>
                <img src={CabinetCastle} alt="LongHaul" style={{borderRight: "solid 0.3vw goldenrod", borderLeft: "solid 0.3vw goldenrod", borderBottom: "solid 0.3vw goldenrod"}}/>
                <p>
