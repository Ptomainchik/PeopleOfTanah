    ...
    return (
        <div className={classes.rulesPage}>
            ...
            {showMessageRules.Message4 && <div> <div className={classes.message}> 
                ...
                <p className={classes.buttonRule} onClick={handleMessage}>-----Начать-----</p></div> <div className={classes.arrow5}></div> <div className={classes.arrow6}></div> <div className={classes.arrow7}></div></div>}
        </div>
    )
}
